...
describe('Transaction', () => {
  ...
  describe('^comparesTo', () => {
    ...
    it('should return 1 when the first transaction earlier than the second transaction and the sort order is descending', () => {
      const firstTransaction = new Transaction(
        1,
        '2024-05-02T09:00:00',
        50.5,
    ...
    it('should return 1 when the first transaction compared to the second transaction and compared by an empty string (based on id) and sort order is descending', () => {
      const firstTransaction = new Transaction(
        1,
        '2024-05-02T09:00:00',
        150.5,
